...
document.addEventListener("DOMContentLoaded", function() {
    let serviceNavItems = document.querySelectorAll('.service-nav-item-blue');
    let FirsterviceNavItem = document.querySelector('#first-service-nav-item');

    // Ajoutez la classe "active-blue" à l'élément au chargement de la page
    FirsterviceNavItem.classList.add('active-blue');
