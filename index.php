    ...
    <div class="carousel-counter">
        <div class="carousel-counter-item" id="1-home-slide">
            ...
            <div class="timer-container">
                <div class="timer-bar timer-bar-blue"  id="timer-bar-0"></div>
        ...
        <div class="carousel-counter-item" id="2-home-slide">
            ...
            <div class="timer-container">
                <div class="timer-bar timer-bar-blue"  id="timer-bar-1"></div>
                <div class="dot-slider"></div>
            </div>
        </div>
        <div class="carousel-counter-item" id="3-home-slide">
            ...
            <div class="timer-container">
                <div class="timer-bar timer-bar-red"  id="timer-bar-2"></div>
                <div class="dot-slider"></div>
            </div>
        </div>
        <div class="carousel-counter-item" id="4-home-slide">
            ...
            <div class="timer-container">
                <div class="timer-bar timer-bar-blue"  id="timer-bar-3"></div>
                <div class="dot-slider"></div>
            </div>
        </div>
        <div class="carousel-counter-item" id="5-home-slide">
            ...
            <div class="timer-container">
                <div class="timer-bar timer-bar-red"  id="timer-bar-4"></div>
                <div class="dot-slider"></div>
            </div>
        </div>
    </div>
